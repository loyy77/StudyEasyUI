...
<html>
	...
	<head>
		...
		<script src="../js/validate/talent-validate-all.js" language="javascript"></script><script src="./demo.js" language="javascript"></script>  <!-- 第一步 -->
		</head><body>
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		<script id="talent_script">
			...
			var remoteV = new tt.RemoteV().set(ajaxConfig);       //服务端验证勿需调用add()方法；取消验证：remoteV.rm(); 添加验证：remoteV.add();
		</script>
</html>
